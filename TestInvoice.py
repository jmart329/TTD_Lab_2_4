...
def test_CanCalculateTotalTax(products):
    ...
    assert invoice.totalTax(products) == 5.203499999999999

def test_CanCalculateFinalPrice(products):
    invoice = Invoice()
    invoice.finalPrice(products)
    assert invoice.finalPrice(products) == 74.58